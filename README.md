...
- Загальні питання
    ...
    - [Що таке канал в Microsoft Teams?](#що-таке-канал-в-microsoft-teams)    
...
## Що таке канал в Microsoft Teams?
**Канал** - це виділений розділ команди, що допомагає упорядкувати бесіди з певних тем, проектів, дисциплін тощо. Канал це саме те місце де відбуваються розмови і де фактично виконується робота.

Канали можуть бути відкриті для всіх членів команди або, якщо вам потрібна більш обрана аудиторія, вони можуть бути приватними. Стандартні канали призначені для розмов, в яких може брати участь кожен член команди, а приватні канали обмежують спілкування для групи людей.

Канали приносять максимальну користь при додаванні в них додатків, що включають вкладки, з'єднувачі і боти, які дають учасникам додаткові можливості. 
