...
- Загальні питання
    ...
    - [Як запланувати урок/подію/нараду?](#як-запланувати-урок/подію/нараду)
    - [Яка максимальна кількість учасників уроку/події/наради?](#яка-максимальна-кількість-учасників-уроку/події/наради)
