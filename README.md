...
- Загальні питання
    ...
    - [Для чого потрібні канали в командах?](#для-чого-потрібні-канали-в-командах)
    - [Як додати канал до команди?](#як-додати-канал-до-команди)
    - [Як в каналі створити оголошення?](#як-додати-канал-до-команди)
    - [Як прикріпити файл до повідомлення?](#як-прикріпити-файл-до-повідомлення)
    - [Як завантажити файл в Microsoft Teams?](#як-завантажити-файл-в-microsoft-teams)
    - [Як створити миттєву нараду?](#як-створити-миттєву-нараду)
    - [Як організувати спілкування для класу?](#як-організувати-спілкування-для-класу)
    - [Яка різниця між миттєвою нарадою і нарадою?](#яка-різниця-між-миттєвою-нарадою-і-нарадою)
    - [Як запланувати урок/подію/нараду?](#як-запланувати-урокподіюнараду)
    - [Яка максимальна кількість учасників уроку/події/наради?](#яка-максимальна-кількість-учасників-урокуподіїнаради)
    - [Чи можна транслювати матеріали під час відеозустрічі в Microsoft Teams?](#чи-можна-транслювати-матеріали-під-час-відеозустрічі-в-microsoft-teams)
    - [Microsoft Teams дозволяє записувати відеозустріч?](#microsoft-teams-дозволяє-записувати-відеозустріч)
    - [Який інструмент допоможе сформувати і поширити завдання для класу?](#який-інструмент-допоможе-сформувати-і-поширити-завдання-для-класу)
    - [Як збирати і оцінювати роботи учнів?](#як-збирати-і-оцінювати-роботи-учнів)
    - [Як учень побачить, що йому задали завдання?](#як-учень-побачить-що-йому-задали-завдання)
    - [Як учню здати на перевірку домашню роботу?](#як-учню-здати-на-перевірку-домашню-роботу)
...
**Приєднайтеся до команди за допомогою коду**
1. Оберіть **Команди** ліворуч на панелі, потім натисніть **Приєднатися або створити нову команду** у верхньому правому куті. 
2. Знайдіть опцію **Приєднайтеся до команди за допомогою коду** та вставте код.

**Приєднайтеся до команди за допомогою посилання** (Не працює, для неавторизованих користувачів)
1. Відкрийте посилання у веб-браузері
...
1.	Натисніть зліва кнопку **«Календар»** та після **Нова нарада**
2.	Додайте назву нарад, її учасників, ввівши імена людей, або додавши канал одної з ваших команд у списку
3.	Визначте час, дату та тривалість наради
    *Опціонально додайте опис до події*
